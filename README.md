...
## 06 Map exersices
Golang Maps is a collection of unordered pairs of key-value. The exercises in this part will help use Maps in practice because it provides fast lookups and values that can retrieve, update or delete with the help of keys.